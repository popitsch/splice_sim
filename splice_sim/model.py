    ...
    if mode == '1:1':
        ...
        for tid, pinfo in tid_meta.items():
            ...
            if frac_old_pre>0: # add 'old' rna isoform
                isoform_data['old_pre'] = OrderedDict()
                isoform_data['old_pre']['splicing_status']=[0] * rnk
                isoform_data['old_pre']['fraction']=frac_old_pre
                isoform_data['old_pre']['is_labeled']=0
        ...
        for tid, pinfo in tid_meta.items():
            ...
            if frac_old_pre>0: # add 'old' rna isoform
                isoform_data['old_pre'] = OrderedDict()
                isoform_data['old_pre']['splicing_status']=[0] * rnk
                isoform_data['old_pre']['fraction']=round(frac_old_pre,3)
                isoform_data['old_pre']['is_labeled']=0
