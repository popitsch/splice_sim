...
tab %>% ggplot(aes(x=condition_id, y=n, col=mapper, linetype=true_isoform, group=paste0(mapper, true_isoform, classification))) + 
    geom_line() + 
...
tab %>% ggplot(aes(x=condition_id, y=m_ntc, col=mapper, linetype=true_isoform, group=paste0(mapper, true_isoform, classification))) + 
    geom_line() + 
    facet_wrap(classification~.) +
    ggtitle( "Mean n_tc per mapper" )
```
