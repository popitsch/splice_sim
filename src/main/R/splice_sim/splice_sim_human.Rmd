...
params:
    splice_sim_config:
       value: "/groups/zuber/zubarchive/USERS/tobias/myProjects/slamdunk/splice_sim/big4_human_slamseq_nf/splice_sim.config.json"
    out_dir:
       value: "/groups/zuber/zubarchive/USERS/tobias/myProjects/slamdunk/splice_sim/big4_human_slamseq_nf/analysis/"
---
<style type="text/css">
body, td {
   font-size: 10px;
