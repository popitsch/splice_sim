...
p0 = mosaic %>% 
  ...
  xlab("Mapper") + ylab("Difference to simulated FMAT") +
...
upper = plot_grid(pMosaicFCR,pFMATMosaicImprovement, labels = c('A', 'B'), rel_widths = c(2,1), nrow=1 )
my_plot_grid(list(upper), 'MOSAIC FCR and FMAT improvement', nrow = 1)
