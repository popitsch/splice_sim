...
# results files (~45 G) 
data_file=paste0(home_dir,'/eva_can_chrom_only/results/data.rds')
data_file_mq20=paste0(home_dir,'/eva_can_chrom_only/results/data.mq20.rds')
meta_file=paste0(home_dir,'/eva_can_chrom_only/results/meta.rds')
...
isoform_mix = load_table('/Volumes/groups/ameres/Niko/projects/Ameres/splicing/data/200513_R9575_pulse_reseq/3_map/STAR/mm10/ns_r1_ip_180/ns_r1_ip_180.gencode.vM21.annotation.nochr.sorted.MAXISOFORM.gff3.data.tsv')
