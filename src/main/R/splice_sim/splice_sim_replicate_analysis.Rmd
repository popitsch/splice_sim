...
home_dir=list(
  "rep1" = "/groups/ameres/Niko/projects/Ameres/splicing/splice_sim/testruns/big4_slamseq_nf/",
  "rep2" = "/groups/ameres/Niko/projects/Ameres/splicing/splice_sim/testruns/big4_slamseq_nf_rep2/",
  "rep3" = "/groups/ameres/Niko/projects/Ameres/splicing/splice_sim/testruns/big4_slamseq_nf_rep3/"
)
fcr_cvsu=cache({
  tab=tibble()
...
fig4 = tab_summary %>% 
  rename(`Mapping unconverted`=map_best_no_conv, 
         `Mapping converted`=map_best_conv, 
         FCR=fcr_best, 
         `FMAT unconverted`=spl_best_no_conv,
         `FMAT converted`=spl_best_conv) %>% 
