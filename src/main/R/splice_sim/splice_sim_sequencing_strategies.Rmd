...
params:
    ...
    genome_3end_config:
       value: "/groups/zuber/zubarchive/USERS/tobias/myProjects/slamdunk/splice_sim/big4_slamseq_3end_genomic_nf_kss/splice_sim.config.json"
    genome_tx_noise_config:
       value: "/groups/zuber/zubarchive/USERS/tobias/myProjects/slamdunk/splice_sim/big4_slamseq_3endcounted_nf_kss/splice_sim.config.json"
    out_dir:
       value: "/groups/zuber/zubarchive/USERS/tobias/myProjects/slamdunk/splice_sim/big4_slamseq_nf_kss/analysis/"
---
<style type="text/css">
body, td {
   font-size: 10px;
...
pMappabilityScoreDistribution <- txmapcmp %>%
...
pAlluvia <- mappabilityClassAlluvia %>%
...
f2a = rbind(
  ...
  calc_ci(diff_STAR) %>%
  ggplot(aes(x=as.numeric(as.character(conversion_rate))*100, y=col.mean, col=tech, group=tech, fill=tech)) +
  geom_hline(yintercept = 0, col='black') +
  geom_ribbon(aes(ymin=col.lower, ymax=col.upper), linetype=2, alpha=0.2) +
  geom_line() +
...
my_plot_grid(list(f2a, f2b, pMappabilityScoreDistribution, pAlluvia), '', labels = T)
ggsave(paste0(params$out_dir, 'Figure_3end_alluvia.pdf'), width=14, height=10)
